...
export default function ErrorPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-rose-100 to-rose-200 px-4">
      <div className="text-center">
        <h1 className="text-9xl font-bold text-rose-500 animate-pulse">500</h1>
